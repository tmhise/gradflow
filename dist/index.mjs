...
`;function De(e){let r=useRef(null),o=useRef(null),t=useRef(null),a=useRef(null),d=useRef(0),n=useMemo(()=>({color1:re(e.color1),color2:re(e.color2),color3:re(e.color3)}),[e.color1,e.color2,e.color3]);return useEffect(()=>{var M;let i=r.current;if(!i)return;let c=new Renderer({canvas:i,dpr:Math.min(window.devicePixelRatio,2),alpha:true,antialias:false,powerPreference:"high-performance",premultipliedAlpha:false});o.current=c;let f=c.gl;f.clearColor(0,0,0,0);let h=new Plane(f,{width:2,height:2}),x=()=>{if(!i.parentElement)return;let A=i.parentElement,y=A.clientWidth,_=A.clientHeight,T=Math.min(window.devicePixelRatio,2);i.width=y*T,i.height=_*T,i.style.width=y+"px",i.style.height=_+"px",c.setSize(y,_),t.current&&(t.current.uniforms.u_resolution.value=[y,_]);},k=new Program(f,{vertex:Ho,fragment:Yo,uniforms:{u_time:{value:0},u_color1:{value:n.color1.rgb},u_color2:{value:n.color2.rgb},u_color3:{value:n.color3.rgb},u_alpha1:{value:n.color1.alpha},u_alpha2:{value:n.color2.alpha},u_alpha3:{value:n.color3.alpha},u_speed:{value:e.speed},u_scale:{value:e.scale},u_type:{value:oe[(M=e.type)!=null?M:"animated"]},u_noise:{value:e.noise},u_resolution:{value:[i.clientWidth,i.clientHeight]}},transparent:true});t.current=k;let P=new Mesh(f,{geometry:h,program:k});a.current=P;let C=new Transform;P.setParent(C),x(),window.addEventListener("resize",x,{passive:true});let R=performance.now(),v=A=>{let y=(A-R)/1e3;k.uniforms.u_time.value=y,c.render({scene:P}),d.current=requestAnimationFrame(v);};return d.current=requestAnimationFrame(v),()=>{var y,_;cancelAnimationFrame(d.current),window.removeEventListener("resize",x);let A=(y=o.current)==null?void 0:y.gl;(_=t.current)!=null&&_.program&&A&&A.deleteProgram(t.current.program),o.current=null,t.current=null,a.current=null;}},[]),useEffect(()=>{var c;let i=t.current;i&&(i.uniforms.u_color1.value=n.color1.rgb,i.uniforms.u_color2.value=n.color2.rgb,i.uniforms.u_color3.value=n.color3.rgb,i.uniforms.u_alpha1.value=n.color1.alpha,i.uniforms.u_alpha2.value=n.color2.alpha,i.uniforms.u_alpha3.value=n.color3.alpha,i.uniforms.u_speed.value=e.speed,i.uniforms.u_scale.value=e.scale,i.uniforms.u_type.value=oe[(c=e.type)!=null?c:"animated"],i.uniforms.u_noise.value=e.noise);},[e,n]),{canvasRef:r,rendererRef:o,programRef:t,meshRef:a}}function te(e){let r=e.replace("#",""),o=parseInt(r,16),t=o>>16&255,a=o>>8&255,d=o&255;return {r:t,g:a,b:d}}function qo(e){let{r,g:o,b:t}=e;return "#"+((1<<24)+(r<<16)+(o<<8)+t).toString(16).slice(1)}function $o(e){return typeof e=="string"?te(e):e}function Xo(e){return typeof e=="object"&&"color"in e}function Jo(e){return typeof e=="object"&&"r"in e&&"g"in e&&"b"in e&&!("color"in e)}function Y(e){if(typeof e=="string"){let r=te(e);return Q(E({},r),{a:1})}if(Xo(e)){let r=typeof e.color=="string"?te(e.color):e.color,o=e.opacity!==void 0?Math.max(0,Math.min(1,e.opacity)):1;return Q(E({},r),{a:o})}return Jo(e)?Q(E({},e),{a:1}):{r:0,g:0,b:0,a:1}}function pe({config:e,className:r=""}){let o=useMemo(()=>{let a=E({},ue);return e&&(e.color1&&(a.color1=Y(e.color1)),e.color2&&(a.color2=Y(e.color2)),e.color3&&(a.color3=Y(e.color3)),e.speed!==void 0&&(a.speed=e.speed),e.scale!==void 0&&(a.scale=e.scale),e.type&&(a.type=e.type),e.noise!==void 0&&(a.noise=e.noise)),a},[e]),{canvasRef:t}=De(o);return jsx("canvas",{ref:t,className:We("w-full h-full block select-none touch-none",r),"aria-label":"gradflow animated gradient background"})}function ae(){return {r:Math.floor(Math.random()*256),g:Math.floor(Math.random()*256),b:Math.floor(Math.random()*256),a:1}}function Zo(){return {color1:ae(),color2:ae(),color3:ae()}}export{ue as DEFAULT_CONFIG,oe as GRADIENT_TYPE_NUMBER,pe as GradFlow,Lo as PRESETS,pe as default,Zo as generateRandomColors,te as hexToRgb,$o as normalizeColor,Y as normalizeColorWithAlpha,ae as randomRGBA,qo as rgbToHex};